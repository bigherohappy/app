...
<!-- 首页中的推荐组件 -->
  <div class="recommend" :style="`height:${$store.state.screenH-101}px`">
    <mt-swipe :auto="2000" style="height:180px">
      <mt-swipe-item>
         <img :src="`${this.Url}images/ban4.jpg`" alt  />
      </mt-swipe-item>
      <mt-swipe-item>
          <img :src="`${this.Url}images/ban5.jpg`" alt />
      </mt-swipe-item>
      <mt-swipe-item>
          <img :src="`${this.Url}images/ban6.jpg`" alt />
      </mt-swipe-item>
        <mt-swipe-item>
         <img :src="`${this.Url}images/ban7.jpg`" alt  />
      </mt-swipe-item>
      <mt-swipe-item>
          <img :src="`${this.Url}images/ban8.jpg`" alt />
      </mt-swipe-item>
      <mt-swipe-item>
